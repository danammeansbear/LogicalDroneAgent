...
from droneinfo import hellodrone
...
if __name__ == '__main__':
    ...
    while True:
        ...
        elif 'drone info' in query:
            speak('Running drone diagnostic')
            hellodrone()
            
        elif 'drone mission' in query:
            speak('Running drone mission, bad ass out')
            mission()
